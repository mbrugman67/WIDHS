...
class dhs(object):
    ...
    def __init__(self):
        ...
        self._urlState = 'https://dhsgis.wi.gov/server/rest/services/DHS_COVID19/COVID19_WI/MapServer/11/query?where=DATE%3E%272020-11-24%2014%3A00%3A00.000000%27&outFields=DATE,POS_NEW,TEST_NEW,NAME,DTH_NEW,HOSP_YES&outSR=4326&f=json'
        self._urlCounty = 'https://dhsgis.wi.gov/server/rest/services/DHS_COVID19/COVID19_WI/MapServer/12/query?where=NAME%3D%27COUNTY%27%20and%20DATE%3E%272020-11-24%2014%3A00%3A00.000000%27&outFields=NAME,DATE,POS_NEW,HOSP_YES,DTH_NEW,TEST_NEW&outSR=4326&f=json'
        self._urlMuni = 'https://dhsgis.wi.gov/server/rest/services/DHS_COVID19/COVID19_WI/MapServer/16/query?where=NAME%3D%27MUNI%27%20and%20DATE%3E%272020-11-24%2014%3A00%3A00.000000%27&outFields=NAME,DATE,POS_NEW,HOSP_YES,DTH_NEW,TEST_NEW&outSR=4326&f=json'
    ...
    def doQuery(self, county, city):
        if county == None and city == None:
            ...
            self._response = requests.get(self._urlState)
        elif city == None:
            ...
            utils.dbgPrint(utils.LOG_DBG, query)
